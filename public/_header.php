                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-section clearfix sidebar-nav-mini-hide">
                                <div class="sidebar-user-name">Javier Filippis</div>
                    ...
                    <header class="navbar navbar-default">
                        ...
                        <div id="horizontal-menu-collapse" class="collapse navbar-collapse pull-right">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="entrevistas-listado.php">Entrevistas</a>
                                </li>
								<li>
                                    <a href="prospecto-listado.php">Prospectos</a>
                                </li>
                                                                                             
                                <li class="dropdown">
                                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">Parametros <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="perfil-listado.php">Usuarios</a></li>
                                        <li class="divider"></li>
										<li><a href="gerencia-listado.php">Gerencias</a></li>
                                        <li class="divider"></li>
                                        <li><a href="parametros-acuerdos.php">Certificado</a></li>
                                    </ul>
                                </li>
