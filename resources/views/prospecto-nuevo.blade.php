...
<div id="page-content">
        ...
        <div class="header-section">
            <div class="row">
				...
				<div class="col-md-3 text-right">
					<a href="/prospecto-listado" class="btn btn-primary">Ir al listado</a>
				</div>
			</div>
        </div>
    </div>
    <div class="block full" data-jsfiles="['form_prospecto.js']">
		...
		<p class="alert alert-success"> <i class="fa fa-exclamation-circle"></i> Los cambios se han guardado con exito! <a class="btn btn-sm btn-success" href="/prospecto-listado">Volver al Listado</a></p>
