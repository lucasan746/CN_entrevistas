    ...
    <body>
        ...
        <div id="login-container" >
            ...
            <div class="block push-bit">
                <!-- Login Form -->
                <form action="{{ route('login') }}" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless" enctype="multipart/form-data">
                @csrf
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="gi gi-envelope"></i></span>
                                <input type="login" id="login-email" name="login" class="form-control input-lg" placeholder="Ingresar Email">
                                @error('login')
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="password" id="login-password" name="password" class="form-control input-lg" placeholder="Ingresar Contrase&ntilde;a">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
